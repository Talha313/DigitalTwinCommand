...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    description:
      "Claude powers the dashboard chat, the daily-report research + script, and grading. The live phone agent's Claude runs natively inside ElevenLabs.",
    status: "connected",
    statusDetail: "Connected · claude-sonnet-5",
    ...
    capabilities: [
      ...
      { id: "web-search", label: "Web search (market reports)", enabled: true },
      { id: "call-brain", label: "Phone agent brain (via ElevenLabs)", enabled: true },
    ],
    fields: [
      {
